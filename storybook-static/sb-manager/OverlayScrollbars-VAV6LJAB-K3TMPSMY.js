        ...
        var PLUGINNAME = "OverlayScrollbars",
              ...
              _jsAPI: function (name, isInterface, fallback) {
                ...
                if (!jsCache[LEXICON.hOP](name)) {
                  for (result = window2[name]; i < jsPrefixes[LEXICON.l]; i++)
                    result =
                      result ||
                      window2[(isInterface ? jsPrefixes[i] : jsPrefixes[i].toLowerCase()) + firstLetterToUpper(name)];
                  jsCache[name] = result;
                }
          ...
          COMPATIBILITY = (function () {
            function windowSize(x) {
              return x
                ? window2.innerWidth || document.documentElement[LEXICON.cW] || document.body[LEXICON.cW]
                : window2.innerHeight || document.documentElement[LEXICON.cH] || document.body[LEXICON.cH];
            }
          ...
          FRAMEWORK = (function () {
            ...
            function each(obj, callback) {
              var i = 0;
              if (isArrayLike(obj)) for (; i < obj[LEXICON.l] && callback.call(obj[i], i, obj[i]) !== !1; i++);
            ...
            function isArrayLike(obj) {
              ...
              return isFunction(t)
                ? !1
                : t == TYPES.a || length2 === 0 || (_type(length2) == TYPES.n && length2 > 0 && length2 - 1 in obj);
            }
            ...
            function matches(elem, selector) {
              for (
                var nodeList = (elem.parentNode || document).querySelectorAll(selector) || [], i = nodeList[LEXICON.l];
                i--;
            ...
            function startNextAnimationInQ(animObj, removeFromQ) {
              ...
              removeFromQ !== !1 && animObj.q.splice(0, 1),
                animObj.q[LEXICON.l] > 0
                  ...
                  : ((index = inArray(animObj, _animations)), index > -1 && _animations.splice(index, 1));
            }
            ...
            function FakejQuery(selector) {
              ...
              if (_type(selector) == TYPES.s)
                for (
                  elements = [],
                    selector.charAt(0) === "<"
                      ? ((el = document.createElement("div")), (el.innerHTML = selector), (elms = el.children))
              ...
              if (elements) {
                for (
                  _type(elements) != TYPES.s &&
                    (!isArrayLike(elements) || elements === window2 || elements === elements.self) &&
                    (elements = [elements]),
                    i = 0;
            ...
            return (
              (FakejQuery[LEXICON.p] = {
                ...
                hasClass: function (className) {
                  for (
                    var elem, i = 0, classNamePrepared = _strSpace + className + _strSpace, classList;
                    (elem = this[i++]);
                  ...
                  if (className) {
                    for (classes = className.match(_rnothtmlwhite) || []; (elem = this[i++]); )
                      if (
                        ...
                        supportClassList === undefined2 && (supportClassList = elmClassList !== undefined2),
                        supportClassList)
                      )
                            ...
                            if (
                              ...
                              for (i = 0; i < templateTypes[LEXICON.l]; i++)
                                if (
                                  ...
                                  (isRestrictedValue =
                                    templateValueType == TYPES.s && inArray(currType, possibleTemplateTypes) === -1),
                                  isRestrictedValue)
                                )
                                  for (
...
` + window2.JSON.stringify(objectCopy, null, 2)
            ...
            function OverlayScrollbarsGlobals(defaultOptions) {
              ...
              var nativeScrollbarSize = calcNativeScrollbarSize(scrollbarDummyElement0),
                nativeScrollbarIsOverlaid = { x: nativeScrollbarSize.x === 0, y: nativeScrollbarSize.y === 0 },
                msie = (function () {
                      ...
                      for (var i = 0; i < _loopingInstances[_strLength]; i++)
                        (instance = _loopingInstances[i]),
                          instance !== undefined2 &&
                            ...
                            (now = _getNow()),
                            (instanceAutoUpdateAllowed === !0 || instanceAutoUpdateAllowed === null) &&
            ...
            function OverlayScrollbarsInstance(pluginTargetElement, options, extensions, globals, autoUpdateLoop) {
              ...
              function setupResponsiveEventListener(element, eventNames, listener, remove2, passiveOrOptions) {
                var collected = COMPATIBILITY.isA(eventNames) && COMPATIBILITY.isA(listener),
                  ...
                  passive =
                    (_supportPassiveEvents && (passiveOrOptionsIsObj ? passiveOrOptions._passive : passiveOrOptions)) ||
                    !1,
                ...
                if (!(_sleeping || _mutationObserversConnected)) {
                  var elem,
                    ...
                    checks = [
                      ...
                      { _elem: _isTextarea ? _targetElement : undefined2, _attrs: _mutationObserverAttrsTextarea },
                    ];
                  return (
                    ...
                    if (sizeAutoCapable)
                      if (
                        ...
                        setupResizeObserver(_sizeAutoObserverElement, function () {
                          ...
                          _cssCalc !== null && _sizeAutoObserverElement.css(_strHeight, _cssCalc + "(100% + 1px)");
                      }
                    else
                    ...
                    if ((_contentElement.css(contentElementCSS), _isTextarea && contentSizeChanged)) {
                      ...
                      if (textareaInfo) {
                        var textareaRowsChanged =
                            _textareaInfoCache === undefined2 ? !0 : textareaInfo._rows !== _textareaInfoCache._rows,
              ...
              function setupStructureDOM(destroy) {
                ...
                (_hostElement =
                  ...
                  (_textareaCoverElement =
                    _textareaCoverElement ||
                    (_isTextarea ? selectOrGenerateDivByClass(_classNameTextareaCoverElement) : undefined2)),
...
`),
                  ...
                  for (i = 0; i < textareaRowSplit[LEXICON.l]; i++)
                    (rowCols = textareaRowSplit[i][LEXICON.l]),
                      rowCols > textareaLastCol && ((widestRow = i + 1), (textareaLastCol = rowCols));
                  return {
                    ...
                    return (
                      isString
                        ? force === _strAuto
                          ...
                          : force === "zoom" && update({ _hostSizeChanged: !0, _contentSizeChanged: !0 })
                ...
                (_base.scroll = function (coordinates, duration, easing, complete) {
                  ...
                  var normalizeRTL = _normalizeRTLCache,
                    ...
                    possibleElementIsJQuery =
                      possibleElement instanceof FRAMEWORK || JQUERY ? possibleElement instanceof JQUERY : !1,
                  ...
                  function getRawScroll(isX, coordinates2) {
                    ...
                    if (type(coordinates2) == TYPES.o) {
                      for (i = 0; i < coordinateProps[strLength]; i++)
                        if (coordinateProps[i] in coordinates2) return coordinates2[coordinateProps[i]];
                    }
                  }
                  function getFinalScroll(isX, rawScroll) {
                    ...
                    if (
                      ...
                      switch (
                        ((operatorCurrScroll = invert ? maxScroll - operatorCurrScroll : operatorCurrScroll), operator)
                      ) {
                        case "+=":
