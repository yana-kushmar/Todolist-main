try {
  ...
  function I(e, t) {
    ...
    if (e && t && (r = e.constructor) === t.constructor) {
      ...
      if (r === Map) {
        if (e.size !== t.size) return !1;
        for (n of e)
          if (((o = n[0]), (o && typeof o == "object" && ((o = Be(t, o)), !o)) || !I(n[1], t.get(o)))) return !1;
        return !0;
      }
  ...
  var st = Object.create,
    ...
    pt = (e, t, r, n) => {
      if ((t && typeof t == "object") || typeof t == "function")
        for (let o of ke(t))
          !ct.call(e, o) && o !== r && se(e, o, { get: () => t[o], enumerable: !(n = lt(t, o)) || n.enumerable });
      return e;
    },
    dt = (e, t, r) => (
      (r = e != null ? st(ut(e)) : {}),
  ...
  var vt = (e) => Array.from({ length: e }, (t, r) => [Q].concat(Array.from({ length: r }, () => "*")).join(".")),
    Tt = (e, t, r, n, o) => {
      let i = []
          .concat(vt(n))
          .concat(r)
        ...
        i.forEach((s) => {
          let l = s.split("."),
            c = (f, d, p) => {
              ...
              else if (E === ze) for (let { name: h, data: y } of t(f)) Z(y, t) && c(y, `${d}.${h}`, p + 1);
              else {
                let h = f[E];
                Z(h, t) && c(h, `${d}.${E}`, p + 1);
              }
    ...
    $e = H((e) => {
      ...
      return a.createElement(
        Ot,
        { expanded: c, onClick: f, shouldShowArrow: l, shouldShowPlaceholder: o > 0, nodeRenderer: i, ...e },
        c
  ...
  var Lt = ({ rows: e, columns: t, rowsData: r }) => {
        ...
        a.createElement(
          ...
          a.createElement(
            ...
            a.createElement(
              "tr",
              null,
              a.createElement(He, { borderStyle: c.none, sorted: r && n, sortAscending: i, onClick: s }, e),
              t.map((f) =>
                a.createElement(
                  He,
                  { borderStyle: c.solid, key: f, sorted: r && o === f, sortAscending: i, onClick: u.bind(null, f) },
                  f
                )
              )
            )
    ...
    Je = (e) =>
      ...
      (e.childNodes.length === 1 && e.childNodes[0].nodeType === Node.TEXT_NODE && e.textContent.length < Ft),
      ...
      switch (t.nodeType) {
        case Node.ELEMENT_NODE:
          return a.createElement(
            "span",
            null,
            a.createElement(zt, { tagName: t.tagName, attributes: t.attributes, styles: n.htmlOpenTag }),
